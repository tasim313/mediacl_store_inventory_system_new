...
from login.decorators import manager_required
from django.utils.decorators import method_decorator
from django.contrib import messages
from django.contrib.auth.decorators import login_required
from medicine.models import Company, MedicineProduct, Sale
from medicine.forms import AddForm, ManagerSaleForm
...
class CreateMedicine(CreateView):
    fields = (
    'company_id', 'name', 'm_type', 'des', 'b_no', 's_no', 'mfg_date', 'expire_date', 'dar_no',
...
@manager_required
def receipt(request):
    sales = Sale.objects.all().order_by('-id').all()
